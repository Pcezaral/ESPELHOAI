...
export async function generateTransformation(
  ...
  const themePrompts: Record<typeof theme, { prompt: string; text: string }> = {
    ...
    natal: {
      // Natal: ROSTO 100% IDÉNTICO, transformação natalína com realidade + fantasia
      prompt: `Christmas transformation. CRITICAL RULE: Keep EXACT same number of people - if 1 person in input, output MUST have 1 person; if 2 people, output MUST have 2 people with BOTH faces pixel-perfect identical. PRESERVE EACH INDIVIDUAL FACE: Face must be PIXEL-PERFECT IDENTICAL - same eyes, nose, mouth, expression, age, skin tone, facial structure. DO NOT modify face. ONLY change: costume, pose, props, background. Randomly choose ONE Christmas character: Santa Claus (full red suit with white fur trim, black belt, Santa hat, white beard, holding gift sack, office/supermarket/street decorated with Christmas lights and ornaments, festive atmosphere), Mrs. Claus (red velvet dress with white fur trim, Santa hat, holding gift boxes, office/home/store decorated with Christmas tree and lights, warm festive setting), Reindeer (brown reindeer costume with antlers headband, red nose, festive sweater, playful pose, urban setting with Christmas decorations, cheerful expression), Elf (green and red elf costume with pointed hat, striped tights, holding toys/gifts, workshop or store background with Christmas decorations, joyful helper), Christmas Angel (white flowing gown with golden wings, halo, holding star, ethereal pose, indoor setting with Christmas tree and lights, magical atmosphere). CRITICAL: Mix reality with fantasy - keep recognizable real-world settings (office, supermarket, street, home) but add Christmas magic (lights, ornaments, snow, decorations). Vary pose (jolly laugh / gift giving / festive wave / cheerful stance). Warm festive lighting with Christmas colors (red, green, gold, white). Photorealistic style with Christmas magic. Random seed: ${randomSeed}`,
      text: "🎄 Você é o espírito do Natal! Espalhe alegria e magia natalina por onde passar! 🎅✨"
    },
    
    reveillon: {
      // Réveillon: ROSTO 100% IDÉNTICO, transformação de ano novo elegante
      prompt: `New Year's Eve 2026 transformation. CRITICAL RULE: Keep EXACT same number of people - if 1 person in input, output MUST have 1 person; if 2 people, output MUST have 2 people with BOTH faces pixel-perfect identical. PRESERVE EACH INDIVIDUAL FACE: Face must be PIXEL-PERFECT IDENTICAL - same eyes, nose, mouth, expression, age, skin tone, facial structure. DO NOT modify face. ONLY change: costume, pose, props, background. Randomly choose ONE New Year scenario: Beach Celebration (elegant white flowing dress or white linen suit, holding champagne glass, beach at night with spectacular colorful fireworks exploding in sky, ocean reflecting lights, festive beach party atmosphere, string lights, "2026" visible in decorations or fireworks), Elegant Dinner Party (formal white suit or white elegant gown, bow tie or jewelry, holding champagne flute, upscale restaurant with golden balloons spelling "2026", candles on table, champagne bottles, confetti, warm golden lighting), Rooftop Party (stylish white outfit, champagne glass, city rooftop with fireworks in background spelling "2026", urban skyline, party lights, celebratory atmosphere, night sky), Yacht Celebration (white nautical elegant outfit, champagne, luxury yacht deck, fireworks over water with "2026" visible, festive maritime setting, glamorous night party). CRITICAL: White clothing is MANDATORY for all scenarios (Brazilian New Year tradition). Add fireworks with "2026", champagne, golden decorations with "2026", confetti. Vary pose (toasting / celebrating / elegant stance / joyful expression). Night lighting with fireworks glow and golden party lights. Photorealistic celebratory style. Random seed: ${randomSeed}`,
