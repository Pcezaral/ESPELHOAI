...
export async function generateTransformation(
  ...
  const themePrompts: Record<typeof theme, { prompt: string; text: string }> = {
    ...
    gangster: {
      // Gangster 1920s: ROSTO 100% IDÉNTICO, ALTA VARIEDADE de cenários de época
      prompt: `1920s Gangster Era transformation. CRITICAL RULE: Keep EXACT same number of people - if 2 people in input, output MUST have 2 people with BOTH faces pixel-perfect identical; if 3 people, output MUST have 3 people with ALL 3 faces pixel-perfect identical. PRESERVE EACH INDIVIDUAL FACE: Each person's face must be PIXEL-PERFECT IDENTICAL - same eyes, nose, mouth, expression, age, skin tone, facial structure. DO NOT modify face. ONLY change: 1920s costume, pose, props, background. Randomly choose ONE scenario with period-accurate details: Speakeasy Boss (pinstripe suit, fedora, cigar, behind bar with whiskey bottles, Art Deco interior), Tommy Gun Shootout (suit with suspenders, fedora, holding tommy gun, dramatic action pose, brick alley with vintage car), Vintage Car Getaway (driving 1920s Ford Model A, fedora, leather jacket, city street background, motion blur), Jazz Club Owner (elegant suit, bow tie, jazz club stage background, musicians silhouettes, smoky atmosphere), Casino High Roller (tuxedo, fedora, poker table with chips and cards, chandelier background, 1920s casino), Bootlegger Deal (trench coat, fedora, wooden crates labeled whiskey, dark warehouse, dramatic lighting), Mob Meeting (three-piece suit, fedora, round table with maps and money, cigar smoke, office with vintage phone), Flapper's Partner (suit and tie, dancing pose with flapper girl silhouette, Art Deco ballroom, champagne), Bank Heist (suit, fedora, money bags, vault door background, dramatic shadows, 1920s bank interior), Rooftop Lookout (overcoat, fedora, binoculars, 1920s city skyline at night, vintage neon signs), Dockyard Smuggler (work suit, cap, wooden barrels, harbor with old ships, foggy night), Valentine's Day Massacre (dramatic suit, fedora, brick wall background, vintage car, film noir lighting). CRITICAL: Period-accurate 1920s clothing, props, cars, architecture. Vary lighting dramatically (film noir shadows / golden hour / neon signs / dramatic spotlights). Vary camera angle (low angle hero shot / side profile / action shot / portrait). Cinematic realistic photo style. Random seed: ${randomSeed}, variation: ${randomVariation}`,
      text: "Você é um gangster dos anos 1920! Elegante, perigoso e dono da noite na era da Lei Seca! 🎩🔫"
    },
    
    circus: {
      // Circo: ROSTO 100% IDÉNTICO, ALTA VARIEDADE de profissões circenses
      prompt: `Circus performer transformation. CRITICAL RULE: Keep EXACT same number of people - if 2 people in input, output MUST have 2 people with BOTH faces pixel-perfect identical; if 3 people, output MUST have 3 people with ALL 3 faces pixel-perfect identical. PRESERVE EACH INDIVIDUAL FACE: Each person's face must be PIXEL-PERFECT IDENTICAL - same eyes, nose, mouth, expression, age, skin tone, facial structure. DO NOT modify face. ONLY change: circus costume, pose, props, background. Randomly choose ONE circus profession with vibrant details: Acrobat (colorful leotard with sequins, mid-air flip pose, juggling colorful balls or clubs, circus tent background with spotlights), Trapeze Artist (sparkly aerial costume, hanging from trapeze bar, dramatic mid-swing pose, high above circus ring, safety net visible below), Clown (colorful baggy costume with polka dots or stripes, red nose, oversized shoes, playful pose with balloons or flowers, circus ring background), Magician (elegant tuxedo with cape and top hat, pulling rabbit from hat or cards fanned out, mysterious pose, stage with magic props and curtains), Ringmaster (red tailcoat with gold buttons, top hat, holding whip or megaphone, commanding pose, center of circus ring with audience silhouettes), Tightrope Walker (elegant costume with balance pole, walking on rope high above ground, focused expression, circus tent interior with lights), Fire Breather (exotic costume with tribal patterns, breathing fire dramatically, intense action pose, dark background with flames illuminating face), Strongman (striped tank top, handlebar mustache, lifting heavy barbell or dumbbells, flexing muscles pose, vintage circus poster style background), Contortionist (flexible pose in colorful bodysuit, bending in impossible position, circus stage with dramatic lighting), Juggler (bright costume, juggling multiple objects (pins, rings, balls), dynamic action pose, circus tent with audience), Lion Tamer (safari-style costume with boots, holding chair and whip, confident pose, circus ring with vintage circus cage silhouette, no real animals), Equilibrist (balancing on large ball or unicycle, colorful costume, arms spread for balance, circus ring with spotlights). CRITICAL: Vibrant circus colors (red, yellow, blue, gold), striped circus tent background or circus ring, dramatic theatrical lighting with spotlights. Vary pose dramatically (action mid-performance / triumphant bow / dramatic entrance / focused concentration). Vary camera angle (low angle heroic / side action shot / front spotlight portrait). Theatrical realistic photo style with circus atmosphere. Random seed: ${randomSeed}, variation: ${randomVariation}`,
