...
ALTER TABLE `premium_downloads` MODIFY COLUMN `theme` varchar(64);--> statement-breakpoint
ALTER TABLE `ratings` MODIFY COLUMN `theme` enum('animals','monster','art','gender','epic','gangster','circus','natal','reveillon','beach') NOT NULL;--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `name` text DEFAULT ('');--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `email` varchar(320) DEFAULT '';--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `loginMethod` varchar(64) DEFAULT '';--> statement-breakpoint
